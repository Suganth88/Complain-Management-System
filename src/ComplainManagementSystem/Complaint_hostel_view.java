...
public class Complaint_hostel_view extends JPanel {
    ...
    DefaultTableModel table_model = new DefaultTableModel(
            new Object[]{"Complaint","Description"
                    ,"Block","Class","Date","Status","UID"},0){
        @Override
    ...
    public void components(){
        ...
        JLabel label_heading = new JLabel("Your Complains on Hostel");
        ...
        JLabel label_description = new JLabel("If you complains have been solved click on update and enter the UID to mark it as Resloved (Or) Click Back to go to Home Page");
    ...
    private void showtable() {
        ...
        try {
            ...
            String rollnumber_string =  bd.getStr_rollno();
                ResultSet rs = st.executeQuery(
                        "select * from complaint_hostel where"
                        + " Rollno = " + "'" + rollnumber_string + "'");
                
               while( rs.next()){
                    table_model.addRow(new Object[]{rs.getString("Complain"),rs.getString("Complaint_Description")
                            ,rs.getString("Block"),rs.getString("Room_No")
                            ,rs.getString("Date"),rs.getString("Status"),rs.getString("UID")});
               }
